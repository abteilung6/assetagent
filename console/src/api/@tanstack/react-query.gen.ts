 ...
 */
export const postTransactionOneOffMutation = (options?: Partial<Options<PostTransactionOneOffData>>): UseMutationOptions<PostTransactionOneOffResponse, PostTransactionOneOffError, Options<PostTransactionOneOffData>> => {
    const mutationOptions: UseMutationOptions<PostTransactionOneOffResponse, PostTransactionOneOffError, Options<PostTransactionOneOffData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postTransactionOneOff({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getRecurringQueryKey = (options?: Options<GetRecurringData>) => createQueryKey('getRecurring', options);

/**
 * List all recurring series
 */
export const getRecurringOptions = (options?: Options<GetRecurringData>) => queryOptions<GetRecurringResponse, DefaultError, GetRecurringResponse, ReturnType<typeof getRecurringQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getRecurringQueryKey(options)
});
...
export const getBaselineCategoryMerchantsQueryKey = (options: Options<GetBaselineCategoryMerchantsData>) => createQueryKey('getBaselineCategoryMerchants', options);
 ...
 *
 */
export const getBaselineCategoryMerchantsOptions = (options: Options<GetBaselineCategoryMerchantsData>) => queryOptions<GetBaselineCategoryMerchantsResponse, GetBaselineCategoryMerchantsError, GetBaselineCategoryMerchantsResponse, ReturnType<typeof getBaselineCategoryMerchantsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getBaselineCategoryMerchants({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getBaselineCategoryMerchantsQueryKey(options)
});

export const getBaselineCategorySpendMonthlyQueryKey = (options: Options<GetBaselineCategorySpendMonthlyData>) => createQueryKey('getBaselineCategorySpendMonthly', options);
 ...
 *
 */
export const getBaselineCategorySpendMonthlyOptions = (options: Options<GetBaselineCategorySpendMonthlyData>) => queryOptions<GetBaselineCategorySpendMonthlyResponse, GetBaselineCategorySpendMonthlyError, GetBaselineCategorySpendMonthlyResponse, ReturnType<typeof getBaselineCategorySpendMonthlyQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getBaselineCategorySpendMonthly({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getBaselineCategorySpendMonthlyQueryKey(options)
});

export const getBaselineDailyExpensePaceQueryKey = (options: Options<GetBaselineDailyExpensePaceData>) => createQueryKey('getBaselineDailyExpensePace', options);
 ...
 *
 */
export const getBaselineDailyExpensePaceOptions = (options: Options<GetBaselineDailyExpensePaceData>) => queryOptions<GetBaselineDailyExpensePaceResponse, GetBaselineDailyExpensePaceError, GetBaselineDailyExpensePaceResponse, ReturnType<typeof getBaselineDailyExpensePaceQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getBaselineDailyExpensePace({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getBaselineDailyExpensePaceQueryKey(options)
});
